...
get = on_command("捡漂流瓶", priority=4, block=True)
report = on_command("举报漂流瓶 ", priority=4, block=True)
comment = on_command("评论漂流瓶 ", priority=4, block=True)
check_bottle = on_command("查看漂流瓶 ", priority=4, block=True)

clear = on_command("清空漂流瓶", permission=SUPERUSER, priority=4, block=True)
remove = on_command("删除漂流瓶 ",permission=SUPERUSER, priority=4, block=True)
