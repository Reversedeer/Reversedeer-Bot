...
wenan_matcher = on_command("文案", aliases={"语录"},
                           priority=3, block=True)
check = on_command("检查更新", priority=1, permission=SUPERUSER, block=False)

# restart = on_command("重启", aliases={"restart"}, priority=1, permission=SUPERUSER, block=False)
