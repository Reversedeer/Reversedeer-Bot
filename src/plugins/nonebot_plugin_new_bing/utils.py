...
CDTIME: int = getattr(config, "cdtime", 10*60)  # 重置会话的cd时间
NICKNAME: str = getattr(config, "bot_nickname", "AI-Md")  # 机器人昵称
...
async def new_chat_(event: MessageEvent, matcher: Matcher, user_id: str, style: str = "balanced") -> str:
    """重置会话"""
