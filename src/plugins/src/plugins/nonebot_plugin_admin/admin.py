...
ban = on_command('禁', priority=9, block=True, permission=SUPERUSER | GROUP_ADMIN | GROUP_OWNER | DEPUTY_ADMIN)
...
unban = on_command('解', priority=9, block=True, permission=SUPERUSER | GROUP_ADMIN | GROUP_OWNER | DEPUTY_ADMIN)
...
change = on_command('改', permission=SUPERUSER | GROUP_ADMIN | GROUP_OWNER | DEPUTY_ADMIN, priority=9, block=True)
...
title = on_command('头衔', priority=9, block=True)
...
title_ = on_command('删头衔', priority=9, block=True)
