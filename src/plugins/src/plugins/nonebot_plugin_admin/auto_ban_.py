...
del_custom_limit_words = on_command('删除违禁词', aliases={'移除违禁词', '去除违禁词'}, priority=10,
...
# TODO: 支持配置是否撤回&禁言
add_custom_limit_words = on_command('添加违禁词', aliases={'增加违禁词', '新增违禁词'}, priority=10,
                                    permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
get_custom_limit_words = on_command('查看违禁词',
                                    aliases={'查看违禁词', '查询违禁词', '违禁词列表'}, priority=10,
                                    permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
