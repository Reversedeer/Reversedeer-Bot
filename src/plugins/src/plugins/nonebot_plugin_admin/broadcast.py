...
on_broadcast = on_command('广播', aliases={'告诉所有人', '告诉大家', '告诉全世界'}, priority=11, block=True,
...
add_broadcast_avoid = on_command('广播排除', priority=11, block=True, permission=SUPERUSER)
...
all_group_list = on_command('群列表', priority=11, block=True, permission=SUPERUSER)
...
avoided_group_list = on_command('排除列表', priority=11, block=True, permission=SUPERUSER)
...
broad_cast_help = on_command('广播帮助', priority=11, block=True)
