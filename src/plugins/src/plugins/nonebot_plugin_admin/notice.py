...
# 查看当前群分管
gad = on_command('分管', aliases={'/gad', '/分群管理'}, priority=12, block=True,
...
# 查看所有分管
su_g_admin = on_command('所有分管', aliases={'/sugad', '/su分群管理'}, priority=12, block=True, permission=SUPERUSER)
...
# 添加分群管理员
g_admin = on_command('分管+', aliases={'/gad+', '分群管理+'}, priority=12, block=True,
                     permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
