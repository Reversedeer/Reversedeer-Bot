...
# 查看所有审批词条
super_sp = on_command('所有词条', aliases={'/susp', '/su审批'}, priority=14, block=True, permission=SUPERUSER)
...
# 按群号添加词条
super_sp_add = on_command('指定词条+', aliases={'/susp+', '/su审批+'}, priority=14, block=True, permission=SUPERUSER)
...
# 按群号删除词条
super_sp_de = on_command('指定词条-', aliases={'/susp-', '/su审批-'}, priority=14, block=True, permission=SUPERUSER)
...
check = on_command('查看词条', aliases={'/sp', '/审批'}, priority=14, block=True,
...
config = on_command('词条+', aliases={'/sp+', '/审批+'}, priority=14, block=True,
                    permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
config_ = on_command('词条-', aliases={'/sp-', '/审批-'}, priority=14, block=True,
                     permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
# 加群审批
group_req = on_request(priority=14, block=True)
