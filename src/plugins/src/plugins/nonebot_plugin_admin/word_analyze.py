...
word_start = on_command('记录本群', block=True, priority=16, permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
word_stop = on_command('停止记录本群', block=True, priority=16, permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
word = on_message(priority=16, block=False)
...
stop_words_add = on_command('添加停用词', aliases={'增加停用词', '新增停用词'}, block=True, priority=16,
...
stop_words_del = on_command('删除停用词', aliases={'移除停用词', '去除停用词'}, block=True, priority=16,
                            permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
stop_words_list = on_command('停用词列表', aliases={'查看停用词', '查询停用词'}, block=True, priority=16,
                             permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
update_mask = on_command('更新mask', aliases={'下载mask'}, block=True, priority=16,
                         permission=GROUP_ADMIN | GROUP_OWNER | SUPERUSER)
...
speak_top = on_command('今日发言排行', aliases={'今日排行榜', '今日发言排行榜', '今日排行'}, block=True, priority=10)
...
who_speak_most = on_command('排行', aliases={'谁话多', '谁屁话最多', '排行', '排行榜'}, block=True, priority=10)
...
get_speak_num_today = on_command('今日发言数', aliases={'今日发言数', '今日发言', '今日发言量'}, block=True, priority=10)
